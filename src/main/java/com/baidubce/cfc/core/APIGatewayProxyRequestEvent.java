...
public class APIGatewayProxyRequestEvent implements Serializable, Cloneable {
    ...
    public static class ProxyRequestContext implements Serializable, Cloneable {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(getServiceId(), that.getServiceId()) &&
                    ...
                    Objects.equals(getResoucePath(), that.getResoucePath());
        }

        @Override
        public int hashCode() {
            return Objects.hash(getServiceId(), getPath(), getHttpMethod(), getRequestId(),
                    getIdentity(), getSourceIp(), getStage(), getapiId(), getResoucePath());
        }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getRequestContext(), getHeaders(), getBody(), getPathParameters(),
                getQueryStringParameters(), getHeaderParameters(), getStageVariables(), getPath(),
                getQueryString(), getHttpMethod(), getResource(), getIsBase64Encoded());
    }
    ...
    public APIGatewayProxyRequestEvent clone() {
        try {
            ...
            throw new IllegalStateException("Got a CloneNotSupportedException from Object.clone()", e);
            // String msg = "Got a CloneNotSupportedException from Object.clone()" +  e.getMessage();
